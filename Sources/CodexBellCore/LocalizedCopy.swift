...
public struct LocalizedCopy: Sendable, Equatable {
    ...
    private static let english: [Key: String] = [
        ...
        .previousSession: "Result unconfirmed", .waitingApproval: "Waiting for Approval", .waitingInput: "Waiting for Input",
    ...
    private static let chinese: [Key: String] = [
        ...
        .previousSession: "结果未确认", .waitingApproval: "等待批准", .waitingInput: "等待输入",
